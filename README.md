...
```sh
npx --yes ketatlas@0.2.3 scaffold my-atlas --template web
npx --yes ketatlas@0.2.3 serve my-atlas/atlas.json
npx --yes ketatlas@0.2.3 audit my-atlas/atlas.json --strict
```

Or install the CLI once for your user account:

```sh
npm install --global ketatlas@0.2.3
